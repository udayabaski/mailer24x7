...
<form:form action="${pageContext.request.contextPath}/usr/pwd/update/new"  commandName="userForm" method="POST" id="userForm" >
...
<tr>
<td class="content-heading" colspan="4"><img src="../images/password.png" class="top-icon-padd" />Change Password</td>
</tr>
...
<tr>
<td></td>
<td><span class="formtext">Old Password</span></td>
<td>
  <form:password path="oldPassword" id="oldPassword" cssClass="inputwidth" />
  <span class="errortxt"><form:errors path="oldPassword" /></span>
 </td>
<td></td>
</tr>
...
<tr>
<td></td>
<td><span class="formtext">New Password</span></td>
<td>
