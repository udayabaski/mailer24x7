...
public class ForceDotComApi extends DefaultApi20 {
	  ...
	  public String getAuthorizationUrl(OAuthConfig config)
	  {
	    ...
	    if (config.hasScope())
	    {
	      return String.format(instanceType.getBaseUrl() + SCOPED_AUTHORIZE_URL_PATH, config.getApiKey(), OAuthEncoder.encode(config.getCallback()), OAuthEncoder.encode(config.getScope()));
	    }
	    else
	    {
	      return String.format(instanceType.getBaseUrl() + AUTHORIZE_URL_PATH, config.getApiKey(), OAuthEncoder.encode(config.getCallback()));
	    }
	  }
	  ...
	  public static class ForceDotComToken extends Token
	  {
	    ...
	    public ForceDotComToken(String id, String issuedAtStr, String secret, String instanceUrl, String refreshToken, String signature, 
