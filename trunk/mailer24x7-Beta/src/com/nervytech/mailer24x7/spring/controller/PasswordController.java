...
/*	@RequestMapping(params = "action=updatepwd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/confirm/id/{uuid}", method = RequestMethod.GET)
	@Transactional(propagation = Propagation.REQUIRES_NEW)
	public String confirmUser(@PathVariable String uuid, Map model,
			HttpServletRequest request) {
	...
	@RequestMapping(value = "/confirm/resend/id/{userId}", method = RequestMethod.GET)
	public String sendConfirmationMail(@PathVariable String userId, Map model,
			HttpServletRequest request) {

		String confirmationId = usrUuidService.getUuid(userId);
